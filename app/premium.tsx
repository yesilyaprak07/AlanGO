...
const BENEFITS = [
  "3x gizli Ã¶dÃ¼l ÅŸansÄ±",
  "GÃ¼nlÃ¼k mystery box",
  "Premium radar sinyali",
  "Daha fazla gÃ¼nlÃ¼k fetih hakkÄ±",
  "+%25 XP ve coin boost",
  "Ã–zel neon iz renkleri",
  "ReklamsÄ±z deneyim",
  "Premium etkinliklere eriÅŸim",
] as const;
...
export default function PremiumScreen() {
  ...
  const bottomTabs = [
    ...
    { key: "store" as const, label: "MaÄŸaza", icon: <ShoppingBag size={16} color={theme.colors.textMuted} /> },
      ...
      >
        <View style={styles.headerRow}>
          <View>
            ...
            <Text style={styles.subtitle}>Daha fazla keÅŸfet. Daha fazla kazan. Daha fazla fethet.</Text>
        ...
        <GlassCard style={styles.heroCard} contentStyle={styles.heroContent}>
          ...
          <RewardCard
            title="Premium AvcÄ± Profili"
            description="Premium Ã¼yeler daha fazla gizli drop keÅŸfeder."
            rewardText="Loot ÅŸansÄ±, radar ve XP avantajÄ± aktif"
                  ...
                  {plan.highlight ? (
                    <View style={styles.planBadgeWrap}>
                      <View style={styles.planBadge}>
                        ...
                        <Text style={styles.planBadgeText}>En avantajlÄ±</Text>
                      </View>
                    </View>
                  ) : null}
                </View>
        ...
        {selectedPlanInfo ? (
          ...
          <ErrorState
            title="Plan bilgisi yÃ¼klenemedi"
        ...
        <HelperText text="Ã–deme entegrasyonu daha sonra aktif edilecektir." tone="warning" style={styles.noteText} />
