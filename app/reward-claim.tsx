...
const CLAIM_STEPS = [
  ...
  { id: 3, label: "YayÄ±n Ä°zni" },
  { id: 4, label: "Ã–deme Bilgisi" },
] as const;
      ...
      <KeyboardAvoidingView style={styles.flex} behavior={Platform.OS === "ios" ? "padding" : undefined}>
        ...
        >
          <View style={styles.headerRow}>
            ...
            <Text style={styles.headerTitle}>Ã–dÃ¼l Talep AdÄ±mlarÄ±</Text>
          ...
          <RewardCard
            title="KeÅŸif Ã–dÃ¼lÃ¼"
            description="DoÄŸrulama tamamlandÄ±ÄŸÄ±nda Ã¶dÃ¼lÃ¼n aktifleÅŸir"
            rewardText="1.000 TL Nakit Ã–dÃ¼l"
            icon="ğŸ†"
            variant="gold"
            onPress={() => {
          ...
          <GlassCard contentStyle={styles.stepCardContent}>
            <Text style={styles.stepTitle}>Instagramâ€™da AlanGOâ€™yu takip et</Text>
            <Text style={styles.stepDesc}>
              Ã–dÃ¼l doÄŸrulamasÄ± iÃ§in resmi sayfamÄ±zÄ± takip etmen gerekiyor.
            </Text>
            <NeonButton
              label={step1Done ? "Takip DoÄŸrulandÄ±" : "Takip Ettim"}
              fullWidth
          ...
          <GlassCard contentStyle={styles.stepCardContent}>
            <Text style={styles.stepTitle}>Selfie videosu gÃ¶nder</Text>
            <Text style={styles.stepDesc}>
              10 saniyelik kÄ±sa bir video ile Ã¶dÃ¼lÃ¼ nasÄ±l bulduÄŸunu anlat.
            </Text>
            <NeonButton
              label={step2Done ? "Video YÃ¼klendi" : "Video YÃ¼kle"}
              fullWidth
          ...
          <GlassCard contentStyle={styles.stepCardContent}>
            <Text style={styles.stepTitle}>YayÄ±n izni</Text>
            <Text style={styles.stepDesc}>
              Videonun AlanGO sosyal medya hesaplarÄ±nda paylaÅŸÄ±lmasÄ±na izin veriyorum.
            </Text>
            ...
            >
              ...
              <Text style={styles.toggleText}>YayÄ±n iznini onaylÄ±yorum.</Text>
            </Pressable>

            <NeonButton
              label="Ä°zin Veriyorum"
              fullWidth
          ...
          <GlassCard contentStyle={styles.stepCardContent}>
            <Text style={styles.stepTitle}>Ã–deme bilgisi</Text>
            <Text style={styles.stepDesc}>
              Ã–dÃ¼lÃ¼n onaylandÄ±ktan sonra hesabÄ±na yatÄ±rÄ±lacak.
            </Text>
          ...
          <View style={styles.securityRow}>
            ...
            <Text style={styles.securityText}>Bilgilerin sadece Ã¶dÃ¼l doÄŸrulamasÄ± iÃ§in kullanÄ±lÄ±r.</Text>
          </View>
        </ScrollView>
      </KeyboardAvoidingView>
    </SafeAreaView>
