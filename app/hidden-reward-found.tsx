  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.title}>Gizli Ã–dÃ¼l Bulundu!</Text>
        <Text style={styles.subtitle}>Bu alanÄ± fethederek nadir bir Ã¶dÃ¼l keÅŸfettin.</Text>

        <RewardCard
          title="Ã–zel KeÅŸif Ã–dÃ¼lÃ¼"
          description="Sponsorlu ÃœrÃ¼n / Token / Kupon varyasyonlarÄ±ndan biri"
        ...
        <Text style={styles.detailText}>Ã–dÃ¼lÃ¼nÃ¼ almak iÃ§in doÄŸrulama adÄ±mlarÄ±nÄ± tamamla.</Text>
      </View>
      ...
      <View style={[styles.footer, { paddingBottom: getBottomCtaPadding(insets.bottom, theme.spacing.md) }]}>
        <GlowPulseView duration={820} minOpacity={0.93} maxOpacity={1} minScale={1} maxScale={1.02}>
          <ShimmerBadge style={styles.ctaShimmerWrap} shimmerColor="rgba(255, 200, 87, 0.22)">
            <NeonButton label="Ã–dÃ¼lÃ¼ Talep Et" fullWidth variant="gold" onPress={() => router.push(ROUTES.rewardClaim)} />
          </ShimmerBadge>
        </GlowPulseView>
