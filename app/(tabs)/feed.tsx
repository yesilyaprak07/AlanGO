...
const FEED_ITEMS: FeedItem[] = [
  {
    id: "1",
    user: "Caner",
    text: "1.240 mÂ² alan fethetti",
    type: "capture",
    detail: "Lara hattÄ±nda yeni sÄ±nÄ±r Ã§izildi.",
    xp: "+340 XP",
    coin: "+120 coin",
    area: "1.240 mÂ²",
  },
  {
    id: "2",
    user: "AyÅŸe",
    text: "gizli Ã¶dÃ¼l buldu",
    type: "reward",
    detail: "Nadir drop sinyali Ã§Ã¶zÃ¼ldÃ¼.",
    xp: "+700 XP",
    coin: "â‚º1.000",
    area: "Ã–dÃ¼l",
  },
  {
    id: "3",
    user: "Mehmet",
    text: "rakip alanÄ±nÄ± ele geÃ§irdi",
    type: "attack",
    detail: "Sahil bÃ¶lgesinde savunma kÄ±rÄ±ldÄ±.",
    xp: "+420 XP",
    coin: "+180 coin",
    area: "860 mÂ²",
  },
  {
    id: "4",
    user: "AlanGO",
    text: "Antalya'da Gold Rush etkinliÄŸi baÅŸladÄ±",
    type: "event",
    detail: "Sadece 12 saat: ekstra Ã¶dÃ¼l ve XP bonusu.",
    xp: "x2 XP",
    coin: "Gold Rush",
    area: "Etkinlik",
  },
...
export default function FeedScreen() {
  ...
  const tabOptions = useMemo(
    () => [
      { key: "kesfet" as const, label: "KeÅŸfet" },
      ...
      >
        <View style={styles.headerRow}>
          <View>
            ...
            <HelperText text="CanlÄ± topluluk hareketleri" />
          </View>
          <NeonButton
            label="CanlÄ±"
            size="sm"
        ...
        <View style={[styles.statRow, narrow && styles.statRowWrap]}>
          <StatCard title="BugÃ¼n XP" value="1.460" subtitle="AkÄ±ÅŸ toplam" icon="âš¡" progress={0.76} style={[styles.statItem, narrow && styles.statItemNarrow]} />
          <StatCard title="Feed Coin" value="+540" subtitle="Topluluk" icon="ğŸª™" progress={0.58} style={[styles.statItem, narrow && styles.statItemNarrow]} />
        </View>
        ...
        {!isLoading && filteredItems.length === 0 ? (
          <EmptyRadarState
            title="Grup AkÄ±ÅŸÄ±"
            message="TakÄ±m akÄ±ÅŸÄ± ve grup savaÅŸ Ã¶zetleri bu alanda listelenecek."
          />
        ) : null}
              ...
              <View style={styles.actionRow}>
                ...
                >
                  <View style={styles.likeInnerRow}>
                    ...
                    <Text style={styles.actionText}>BeÄŸen</Text>
                  </View>
                </AnimatedPressable>
                <Pressable
