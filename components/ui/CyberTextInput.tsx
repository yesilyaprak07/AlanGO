...
import { Animated, Pressable, StyleProp, StyleSheet, Text, TextInput, TextInputProps, TextStyle, View, ViewStyle } from "react-native";
...
export function CyberTextInput({
  ...
  return (
    <View style={containerStyle}>
      ...
      <Animated.View style={[styles.inputWrap, { borderColor: animatedBorderColor, backgroundColor: animatedBg }, inputWrapStyle]}>
